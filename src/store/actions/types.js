...
export const USER_CARD_UPDATED = 'USER_CARD_UPDATED';
export const USER_CARD_UPDATE_FAILED = 'USER_CARD_UPDATE_FAILED';
export const GET_USER_CARD_SUCCESS = 'GET_USER_CARD_SUCCESS';
export const GET_USER_CARD_FAILURE = 'GET_USER_CARD_FAILURE';
